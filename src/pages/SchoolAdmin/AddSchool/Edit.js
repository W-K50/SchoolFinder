...
const Edit = () => {
  ...
  useEffect(() => {
    ...
    setemail(SchoolProfileState?.email);
    setschoolIntro(SchoolProfileState?.schoolIntro);
    setmobile(SchoolProfileState?.mobile);
    setwebsiteURL(SchoolProfileState?.websiteURL);
    setacademic(SchoolProfileState?.academic);
    setcurriculum(SchoolProfileState?.curriculum);
    setcity(SchoolProfileState?.city);
  ...
  const UploadCoverPhoto = async (image, purpose) => {
    ...
    formData.append("authuploadID", AuthState.id);
    formData.append("schoolProfileID", AuthState?.SchoolProfile.id);
  ...
  const UploadLogoPhoto = async (image, purpose) => {
    ...
    formData.append("purpose", purpose);
    return axios
      .post(PhotoUpload, formData, configLogo)
      .then((resp) => {
        console.log(resp.data);
        setIsProgressBar(false);
      })
  ...
  const UploadPhoto = async (image, purpose) => {
    let formData = new FormData();
  ...
  const UploadProposal = async (image, purpose) => {
    let formData = new FormData();
    console.log(image);
    formData.append("UploadPhoto", image);
    formData.append("authuploadID", AuthState.id);
    ...
    formData.append("purpose", purpose);
    return axios
      .post(PhotoUpload, formData, PerposalConfig)
      .then((resp) => {
        console.log(resp.data);
        // setIsProgressBar(false);
      })
      ...
      <div class="container px-5 md:mx-auto bg-transparent backdrop-blur-md text-white p-10 border-2 border-gray-600 rounded-xl mt-14">
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-2">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => {
                ...
                UploadProposal(e.target.files[0], "schoolperposal");
              }}
            />
          </div>

          <h5 class="col-span-2 md:col-span-2 text-2xl font-normal py-5 text-gray-900">
            Add Gallery Images
          </h5>
          <div class="md:col-span-2 flex items-center">
                ...
                <div
                  ...
                  onClick={async () => {
                    await axios
                      ...
                      .then((resp) => {
                        console.log(resp.data);
                        let deleteImage = Images.filter((img) => img !== image);
            ...
            <div
              class="w-28 h-14 bg-gray-300 rounded-lg flex items-center justify-center hover:cursor-pointer hover:bg-slate-400"
